                  ...
                  <div class="mt-4 space-y-4">
                    <div>
                      <div class="flex justify-between items-center">
                        <label for="editWorkspaceName" class="form-label">Veri Seti Adı *</label>
                    ...
                    <div>
                      <label for="editOrganType" class="form-label">Organ Tipi *</label>
                      <input
                        type="text"
                        v-model="organType"
                        id="editOrganType"
                    ...
                    <div>
                      <label for="editResource" class="form-label">Kaynak Tipi *</label>
                      <select v-model="resource" id="editResource" class="form-input">
                    ...
                    <div class="border-t pt-4 space-y-4">
                        <div>
                            <label for="editOrganization" class="form-label">Oluşturan Kurum *</label>
                            <input
                              type="text"
                        ...
                        <div>
                            <label for="editLicense" class="form-label">Lisans *</label>
                            <input
                              type="text"
                              v-model="license"
                              id="editLicense"
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                <label for="editReleaseYear" class="form-label">Yıl *</label>
                                <input
                                  type="number"
                                  v-model="releaseYear"
                                  id="editReleaseYear"
                            ...
                            <div>
                                <label for="editReleaseVersion" class="form-label">Sürüm (Opsiyonel)</label>
                                <input type="text" v-model="releaseVersion" id="editReleaseVersion" class="form-input" placeholder="Örn: v1.0">
                            </div>
                        </div>
                    </div>

                    <div v-if="resource === 'public'">
                        <label for="editResourceURL" class="form-label">Kaynak URL'i *</label>
                        <input
                          type="url"
                          v-model="resourceURL"
                          id="editResourceURL"
...
const props = defineProps({ isOpen: Boolean, initialData: Object });
const emit = defineEmits(['close', 'updated']);
const MAX_NAME_LENGTH = 50;
const originalName = ref(''); // Orijinal adı saklamak için
const name = ref('');
const organType = ref('');
...
watch(() => props.initialData, (newData) => {
    if (newData) {
        originalName.value = newData.name || ''; // Orijinal adı sakla
        ...
        originalName.value = ''; // Modal kapanırsa veya veri yoksa sıfırla
    }
}, { immediate: true });
...
const updateWorkspace = () => {
    ...
    const updatedData = {
        // Orijinal adı da gönderiyoruz ki WorkSpaceView'de bulabilelim
        ...
        resourceURL: resource.value === 'public' ? resourceURL.value.trim() : ''
    };
