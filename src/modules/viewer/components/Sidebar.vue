  ...
  <div class="sidebar">
    ...
    <div class="dataset-tree">
      <div class="tree-content">
        ...
        <div v-else>
          <div v-for="(images, datasetName) in filteredGroupedImages" :key="datasetName" class="dataset-group">
            <!-- Dataset Header -->
            <div
  ...
  setup(props) {
    ...
    const groupedImages = computed(() => {
      if (!Array.isArray(props.images)) {
        console.warn('images is not an array:', props.images)
        return {}
      }
...
/* Scrollbar Styles */
.dataset-tree::-webkit-scrollbar {
  width: 6px;
}

.dataset-tree::-webkit-scrollbar-track {
  background: #f1f1f1;
}
...
.dataset-tree::-webkit-scrollbar-thumb:hover {
  background: #a1a1a1;
}
</style>
