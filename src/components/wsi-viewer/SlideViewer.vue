        ...
        <div class="navigation-box">
          ...
          <div class="prev-next-column">
            ...
            <button @click="openPreviousSlide">
              <img src="../../assets/css/viewer-assets/previous.svg" alt="Geri" width="22" height="22" />
              <span>Geri</span>
            </button>
            <button @click="openNextSlide">
              <span>İleri</span>
              <img src="../../assets/css/viewer-assets/next.svg" alt="İleri" width="22" height="22" />
            </button>
          </div>
        </div>
        ...
        <div class="tool-box">
          ...
          <div class="tool-buttons-row">
            <div class="tool-buttons">
              ...
              >
                <img src="../../assets/css/viewer-assets/bbox.svg" alt="BBox" width="22" height="22" />
              </button>
